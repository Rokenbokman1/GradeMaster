...
<div class="navbar navbar-inverse navbar-fixed-top">
	<div class="navbar-inner">
		<div class="container">
			...
			</a> <a class="brand" href="index.do"> <% if (loggedIn) { %> <%= iConfig.get("namePrefix") %><%= user.get("fname").getTextValue()+" "+user.get("lname").getTextValue() %>
				<% } else { %> <%= iConfig.get("namePrefix") %><%= iConfig.get("name") %>
				<% } %>
			</a>
